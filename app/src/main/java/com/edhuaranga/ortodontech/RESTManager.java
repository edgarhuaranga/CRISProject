...
public class RESTManager {
    ...
    static public RESTManager getInstance(Application context){
        if(restManager==null)
    ...
    public void addStringRequest(int method, final String label, String url, Response.Listener<String> responseListener, Response.ErrorListener errorListener, @Nullable final Map<String, String> params){
